...
describe('ProductService.findForId (active)', () => {
  ...
  it('should find active product when user is root', async () => {
  ...
  it('should find active product when user is admin', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should find active product when user basic user', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should find active product when user is not authenticated', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should find inactive product when user is root', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should find inactive product when user is admin', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should not find inactive product when user basic user', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
  ...
  it('should not find active product when user is not authenticated', async () => {
    const [productId1, productId2, productId3] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await testGetMin(
      app,
