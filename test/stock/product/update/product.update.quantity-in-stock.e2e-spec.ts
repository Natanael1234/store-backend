...
describe('ProductController (e2e) - patch /products/:productId (quantityInStock)', () => {
  ...
  it(`should accept create when quantityInStock is minimum allowed`, async () => {
  ...
  it(`should accept create when quantityInStock is maximum allowed`, async () => {
    const [brandId1] = await insertBrands({ name: 'Brand 1', active: true });
    const [categoryId1] = await insertCategories({
      name: 'Category 1',
      active: true,
  ...
  it(`should accept create when quantityInStock is undefined`, async () => {
    const [brandId1] = await insertBrands({ name: 'Brand 1', active: true });
    const [categoryId1] = await insertCategories({
      name: 'Category 1',
      active: true,
    ...
    const quantityInStock = undefined;
    const productId = productId2;
    const expectedResults = [
      {
        id: productId1,
