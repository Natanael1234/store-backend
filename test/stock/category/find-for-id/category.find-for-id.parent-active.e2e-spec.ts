...
describe('CategoryController (e2e) - get/:categoryId /categories (parent.active)', () => {
  ...
  it('should retrieve category and its active parent when user is root', async () => {
  ...
  it('should retrieve category and its active parent when user is admin', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category and its active parent when user is basic user', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category and its active parent when user is not authenticated', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category and its inactive parent when user is root', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category and its inactive parent when user is admin', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category without its inactive parent when user is basic user', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
  ...
  it('should retrieve category without its inactive parent when user is not authenticated', async () => {
    const [categoryId1, categoryId2, categoryId3, categoryId4] =
      await createTestScenario();
    const categoriesBefore = await findCategories();
    const response = await testGetMin(
