import { ImagesMetadataMessage } from './images-metadata.messages.enum';

describe('ImagesMetadataMessage', () => {
  it('should be defined', () => {
    expect(ImagesMetadataMessage).toBeDefined();
  });

  it('should have valid keys and values', () => {
    expect({ ...ImagesMetadataMessage }).toEqual({
      // additional data
      ...
      METADATA_ITEM_INVALID_TYPE:
        'File metadata item should be a valid image file metadata',
      ...
      // imageId or fileIdx
      IMAGE_ID_AND_FILE_IDX_NOT_DEFINED:
        'Both Image id and file index not defined',
