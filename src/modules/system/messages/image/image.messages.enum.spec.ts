import { ImageMessage } from './image.messages.enum';
...
describe('ImageMessage', () => {
  ...
  it('should have valid keys and values', () => {
    expect({ ...ImageMessage }).toEqual({
      ...
      IMAGES_NOT_DEFINED: 'Images not defined',
      IMAGES_EMPTY_LIST: 'Image list is empty',
      ...
      IMAGE_ID_LIST_ITEM_INVALID:
        'Image id list items should be integers greater or equal 1',
    });
  });
});
