...
describe('ProductService.update (categoryId)', () => {
  ...
  it(`should accept update when categoryId is valid`, async () => {
    ...
    const expectedResults = [
      ...
      },
      {
        ...
        category: { id: categoryId, name: 'Category 1', active: true },
        images: [],
      },
    ];
  ...
  it(`should accept update when categoryId is undefined`, async () => {
    ...
    const data = { name: 'New Name', categoryId };
    const expectedResults = [
      {
        id: productId1,
        code: '00000001',
  ...
  it(`should reject update when categoryId is null`, async () => {
    ...
    const productsBefore = await productRepo
      ...
      .getMany();
    const fn = () => productService.update(productId2, { categoryId: null });
