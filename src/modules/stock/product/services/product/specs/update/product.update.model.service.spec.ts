...
describe('ProductService.update (model)', () => {
  ...
  it(`should accept when model has minimum allowed length`, async () => {
  ...
  it(`should accept when model has maximum allowed length`, async () => {
    const [brandId1] = await insertBrands({ name: 'Brand 1', active: true });
    const [categoryId1] = await insertCategories({
      name: 'Category 1',
      active: true,
  ...
  it('should reject when model is too short', async () => {
    ...
    const fn = () =>
      productService.update(productId1, {
        model: 'x'.repeat(
          ProductConfigs.MODEL_MIN_LENGTH - 1,
  ...
  it('should reject when model is null', async () => {
    ...
    const productsBefore = await productRepo
      ...
      .getMany();
    const fn = () =>
      productService.update(productId1, { model: null as unknown as string });
    await expect(fn()).rejects.toThrow(UnprocessableEntityException);
    const productsAfter = await productRepo
      .createQueryBuilder(ProductConstants.PRODUCT)
      .leftJoinAndSelect(ProductConstants.PRODUCT_BRAND, ProductConstants.BRAND)
  ...
  it('should reject when model is number', async () => {
    ...
    const productsBefore = await productRepo
      ...
      .getMany();
    const fn = () =>
      productService.update(productId1, { model: 1 as unknown as string });
    await expect(fn()).rejects.toThrow(UnprocessableEntityException);
    const productsAfter = await productRepo
      .createQueryBuilder(ProductConstants.PRODUCT)
      .leftJoinAndSelect(ProductConstants.PRODUCT_BRAND, ProductConstants.BRAND)
  ...
  it('should reject when model is boolean', async () => {
    ...
    const productsBefore = await productRepo
      ...
      .getMany();
    const fn = () =>
      productService.update(productId1, { model: true as unknown as string });
    await expect(fn()).rejects.toThrow(UnprocessableEntityException);
    const productsAfter = await productRepo
      .createQueryBuilder(ProductConstants.PRODUCT)
      .leftJoinAndSelect(ProductConstants.PRODUCT_BRAND, ProductConstants.BRAND)
  ...
  it('should reject when model is array', async () => {
    ...
    const productsBefore = await productRepo
      ...
      .getMany();
    const fn = () =>
      productService.update(productId1, { model: [] as unknown as string });
    await expect(fn()).rejects.toThrow(UnprocessableEntityException);
    const productsAfter = await productRepo
      .createQueryBuilder(ProductConstants.PRODUCT)
      .leftJoinAndSelect(ProductConstants.PRODUCT_BRAND, ProductConstants.BRAND)
