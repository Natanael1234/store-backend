...
describe('ProductService.findForId (brand)', () => {
  ...
  it('should find product with active category when publicAccess = true', async () => {
  ...
  it('should find product with active category when publicAccess = false', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
    const response = await productService.findById(productId1, true);
    expect(await getProducts()).toEqual(productsBefore);
  ...
  it('should find product with active category when publicAccess = null', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with active category when publicAccess = undefined', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with active category when publicAccess is not defined', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with inactive category when publicAccess = false', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with inactive category when publicAccess = null', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with inactive category when publicAccess = undefined', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should find product with inactive category when publicAccess is not defined', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
  ...
  it('should not find product with inactive category when publicAccess = true', async () => {
    const [productId1, productId2] = await createTestScenario();
    const productsBefore = await getProducts();
