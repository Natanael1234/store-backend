...
describe('ProductImageService.bulkSave (metadata.active)', () => {
  ...
  describe('create', () => {
    ...
    it('should reject create image when metadata.active is null', async () => {
      ...
      const fn = () =>
        productImageService.bulkSave(productId1, imageFiles, {
          metadatas: [{ active: null, imageIdx: 0 }],
        });
      ...
      try {
        ...
        expect(ex.getResponse()).toEqual({
          ...
          message: { metadatas: ImagesMetadataMessage.ACTIVE_IS_NULL },
    ...
    it('should reject create image when metadata.active is number', async () => {
      ...
      const fn = () =>
        productImageService.bulkSave(productId1, imageFiles, {
          metadatas: [{ active: 1 as unknown as boolean, imageIdx: 0 }],
        });
      ...
      try {
        ...
        expect(ex.getResponse()).toEqual({
          error: ExceptionText.UNPROCESSABLE_ENTITY_EXCEPTION,
          message: { metadatas: ImagesMetadataMessage.ACTIVE_IS_INVALID },
          statusCode: HttpStatus.UNPROCESSABLE_ENTITY,
        });
      }
    ...
    it('should reject create image when metadata.active is string', async () => {
      ...
      const fn = () =>
        productImageService.bulkSave(productId1, imageFiles, {
          metadatas: [{ active: 'true' as unknown as boolean, imageIdx: 0 }],
        });
    ...
    it('should reject create image when metadata.active is array', async () => {
      ...
      const fn = () =>
        productImageService.bulkSave(productId1, files, {
          metadatas: [{ active: [] as unknown as boolean }],
        });
    ...
    it.skip('should make image files private', async () => {
      // TODO: on delete too
