...
describe('CategoryService.findForId (active)', () => {
  ...
  it('should find not deleted category when publicAccess is true', async () => {
  ...
  it('should find not deleted category when publicAccess is false', async () => {
    const [categoryId1, categoryId2] = await insertCategories(
      { name: 'Category 1', active: true },
      { name: 'Category 2', active: true, deletedAt: new Date() },
    );
  ...
  it('should find not deleted category when publicAccess is null', async () => {
    const [categoryId1, categoryId2] = await insertCategories(
      { name: 'Category 1', active: true },
      { name: 'Category 2', active: true, deletedAt: new Date() },
    );
  ...
  it('should find not deleted category when publicAccess is undefined', async () => {
    const [categoryId1, categoryId2] = await insertCategories(
      { name: 'Category 1', active: true },
      { name: 'Category 2', active: true, deletedAt: new Date() },
    );
  ...
  it('should find not deleted category when publicAccess is not defined', async () => {
    const [categoryId1, categoryId2] = await insertCategories(
      { name: 'Category 1', active: true },
      { name: 'Category 2', active: true, deletedAt: new Date() },
    );
  ...
  it('should not find deleted category when publicAccess is true', async () => {
    const [categoryId1, categoryId2] = await insertCategories(
      { name: 'Category 1', active: true },
      { name: 'Category 2', active: true, deletedAt: new Date() },
    );
