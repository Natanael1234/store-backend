...
1;
describe('CategoryService.findForId (parent.active)', () => {
  ...
  describe('active parent', () => {
    it('should retrieve category with its active parent when publicAccess = true', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
    ...
    it('should retrieve category and its active parent when publicAccess = false', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its active parent when publicAccess = null', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
      const response = await categoryService.findById(categoryId3, false);
    ...
    it('should retrieve category and its active parent when publicAccess = undefined', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its active parent when publicAccess is not defined', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
  ...
  describe('inactive parent', () => {
    it('should retrieve category without its inactive parent when publicAccess = true', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its inactive parent when publicAccess = false', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its inactive parent when publicAccess = null', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its inactive parent when publicAccess = undefined', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
    ...
    it('should retrieve category and its inactive parent when publicAccess is not defined', async () => {
      const [categoryId1, categoryId2, categoryId3, categoryId4] =
        await createTestScenario();
      const categoriesBefore = await getCategories();
