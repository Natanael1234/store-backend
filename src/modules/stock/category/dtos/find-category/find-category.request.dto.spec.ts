...
import { FindCategoryRequestDTO } from './find-category.request.dto';

const ActiveMessage = new BoolMessage('active');
const DeletedMessage = new BoolMessage('deleted');

async function testAccept(
  data: FindCategoryRequestDTO,
  expectedResult: FindCategoryRequestDTO,
) {
  const dto = plainToInstance(FindCategoryRequestDTO, data);
  expect(dto).toEqual(expectedResult);
  const errors = await validateFirstError(data, FindCategoryRequestDTO);
...
describe('FindCategoryRequestDTO', () => {
