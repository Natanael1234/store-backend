  ...
  it('should have valid keys and values', () => {
    expect({ ...CategoryMessage }).toEqual({
      ...
      PARENT_CATEGORY_ID_TYPE:
        'Parent category id should be integer greater or equal 1',
      ...
      INVALID_CATEGORY_ID_LIST_ITEM:
        'Category id list items should be integers greater or equal 1',
      ...
      INVALID_PARENT_CATEGORY_ID_LIST:
        'Parent category id list should be an array',
