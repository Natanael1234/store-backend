export enum CategoryMessage {
  ...
  INVALID_CATEGORY_ID_LIST_ITEM = 'Category id list items must be integers greater or equal 1',
  ...
  INVALID_PARENT_CATEGORY_ID_LIST = 'Parent category id list must be an array',
  INVALID_PARENT_CATEGORY_ID_LIST_ITEM = 'Parent category id list items must be integers greater or equal 1',
