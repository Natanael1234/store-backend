...
describe('BrandService.findForId ()', () => {
  ...
  it('should find active brand when publicAccess is true', async () => {
  ...
  it('should find active brand when publicAccess is false', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find active brand when publicAccess null', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find active brand when publicAccess undefined', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find active brand when publicAccess is not defined', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find inactive brand when publicAccess is false', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find inactive brand when publicAccess is null', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find inactive brand when publicAccess is undfined', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should find inactive brand when publicAccess is not defined', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
  ...
  it('should not find inactive brand when publicAccess is true', async () => {
    const [brandId1, brandId2] = await testInsertBrands(brandRepo, [
      { name: 'Brand 1', active: true },
      { name: 'Brand 2', active: false },
    ]);
